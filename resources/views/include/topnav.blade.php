 <div class="container-fluid py-1 px-3">
      <nav aria-label="breadcrumb">
         ...
         <h6 class="font-weight-bolder mb-0">Boshqaruv Panili</h6>
      </nav>
         ...
         <li class="nav-item d-flex align-items-center">
                @if (Route::has('register'))
                    <li class="nav-item active">
                        <a style="{{ (Request::is('register') ? 'color: green; text-decoration: underline;' : '') }}   ;  padding-top: 14px;"  class="nav-link {{ (Request::is('register') ? 'active' : '') }}" href="{{ route('register') }}"><span>{{ __('Register') }}</span></a>
                    </li>
                @endif
               </li>
